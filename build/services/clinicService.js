...
var createClinic = function createClinic(data, image) {
...
var getAllClinic = function getAllClinic(page, size) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 7;
            return _index["default"].Clinic.findAndCountAll({
              raw: true,
              nest: true,
              limit: size,
              offset: page * size,
...
var handleEditClinic = function handleEditClinic(data, image) {
  return new Promise( /*#__PURE__*/function () {
