...
var getDoctorBySpecial = function getDoctorBySpecial(id, page, size) {
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      var pageAsNumber, sizeAsNumber, doctors;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            pageAsNumber = Number.parseInt(page);
            sizeAsNumber = Number.parseInt(size); // let page = 0 ;
            ...
            _context3.next = 7;
            return _index["default"].DoctorInfor.findAndCountAll({
              where: {
                specialtyId: id
              },
              include: [{
...
var getDoctorByClinic = function getDoctorByClinic(id, page, size) {
  return new Promise( /*#__PURE__*/function () {
    ...
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            if (!(!inputData.doctorId || !inputData.contentHTML || !inputData.action || !inputData.priceId || !inputData.specialtyId || !inputData.paymentId || !inputData.provinceId || !inputData.nameClinic || !inputData.addressClinic || !inputData.note || !inputData.clinicId)) {
              _context5.next = 5;
              break;
            }
            resolve({
          ...
          case 24:
            doctorInfor = _context5.sent;
            if (!doctorInfor) {
              _context5.next = 32;
              break;
            }
            //update
            doctorInfor.priceId = inputData.priceId, doctorInfor.provinceId = inputData.provinceId, doctorInfor.paymentId = inputData.paymentId, doctorInfor.addressClinic = inputData.addressClinic, doctorInfor.nameClinic = inputData.nameClinic, doctorInfor.note = inputData.note, doctorInfor.specialtyId = inputData.specialtyId, doctorInfor.clinicId = inputData.clinicId;
            _context5.next = 29;
...
var getSearchDoctor = function getSearchDoctor(q, type) {
  return new Promise( /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(resolve, reject) {
      var data, _data, _data2, _data3, _data4, _data5, _data6;
          ...
          case 0:
            ...
            return _index["default"].User.findAll({
              where: _defineProperty({}, _sequelize.Op.or, [{
                firstName: _defineProperty({}, _sequelize.Op.like, "%" + q + "%")
              }]),
              attributes: {
                exclude: ["image"]
              },
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          ...
          case 9:
            ...
            _context8.next = 12;
            return _index["default"].Schedule.bulkCreate(data.arrSchedule);
          case 12:
            resolve({
              errCode: 0,
              errMessage: "OK"
...
var getScheduleByDate = function getScheduleByDate(id, dateInput) {
  return new Promise( /*#__PURE__*/function () {
...
var getExtraInforDoctorById = function getExtraInforDoctorById(inputId) {
  return new Promise( /*#__PURE__*/function () {
...
var getListPatientForDoctor = function getListPatientForDoctor(doctorId, date, statusId, page, size) {
  return new Promise( /*#__PURE__*/function () {
    var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(resolve, reject) {
      var pageAsNumber, sizeAsNumber, data;
...
var getListHistoryPatient = function getListHistoryPatient(doctorId, date, page, size) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          ...
          case 5:
            ...
            _context13.next = 11;
            return _index["default"].History.findAndCountAll({
              where: {
                doctorId: doctorId,
                date: date
              },
...
var sendRemedy = function sendRemedy(data, image) {
  return new Promise( /*#__PURE__*/function () {
