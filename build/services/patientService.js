...
var buildUrlEmail = function buildUrlEmail(doctorId, token) {
  var result = "".concat(process.env.URL_WEBSITE, "/verify-Booking?token=").concat(token, "&doctorId=").concat(doctorId);
  return result;
};
var postBookAppointment = function postBookAppointment(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var token, dataSchedule, user, handle;
