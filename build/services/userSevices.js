...
var handleGetUserDetails = function handleGetUserDetails(userId) {
  return new Promise( /*#__PURE__*/function () {
...
var getAllUsers = function getAllUsers(page, size, type, q) {
  return new Promise( /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      var pageAsNumber, sizeAsNumber, users, _users, _users2, _users3, _users4, _users5, _users6, _users7;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 15:
            ...
            resolve({
              data: _users.rows,
              totalPages: Math.ceil(_users.count / size)
            });
          case 17:
            _context5.next = 59;
            break;
          ...
          case 23:
            ...
            resolve({
              data: _users2.rows,
              totalPages: Math.ceil(_users2.count / size)
            });
            _context5.next = 31;
            break;
          case 27:
          ...
          case 29:
            _users3 = _context5.sent;
            resolve({
              data: _users3.rows,
              totalPages: Math.ceil(_users3.count / size)
            });
          case 31:
            _context5.next = 59;
            break;
          ...
          case 37:
            _users4 = _context5.sent;
            resolve({
              data: _users4.rows,
              totalPages: Math.ceil(_users4.count / size)
            });
            _context5.next = 45;
            break;
          case 41:
          ...
          case 43:
            _users5 = _context5.sent;
            resolve({
              data: _users5.rows,
              totalPages: Math.ceil(_users5.count / size)
            });
          case 45:
            _context5.next = 59;
            break;
          ...
          case 51:
            _users6 = _context5.sent;
            resolve({
              data: _users6.rows,
              totalPages: Math.ceil(_users6.count / size)
            });
            _context5.next = 59;
            break;
          case 55:
          ...
          case 57:
            _users7 = _context5.sent;
            resolve({
              data: _users7.rows,
              totalPages: Math.ceil(_users7.count / size)
            });
          case 59:
            _context5.next = 64;
            break;
...
var createNewUser = function createNewUser(data, image) {
  return new Promise( /*#__PURE__*/function () {
...
var updateUserData = function updateUserData(data, image) {
  return new Promise( /*#__PURE__*/function () {
